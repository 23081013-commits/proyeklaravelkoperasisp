...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('pinjaman.index')); ?>" class="btn btn-secondary btn-sm shadow-sm">
        ...
        <div class="card-body p-4">
            <form action="<?php echo e(route('pinjaman.store')); ?>" method="POST">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('pinjaman.index')); ?>" class="btn btn-light px-4">Batal</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\koperasi-app\resources\views/pinjaman/create.blade.php ENDPATH**/ ?>